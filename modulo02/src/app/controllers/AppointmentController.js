  ...
  async store(req, res) {
    ...
    */
    if (req.userId === provider_id) {
      return res
        .status(401)
        .json({ error: 'you can not do an appointment with you ' });
    }
    ...
    // the parseISO turn the string date in a object js date
    // startOfHour it always will get the initial date not the minutes and seconds
    ...
    /**
     * check if it has already a appointment in that hour
     */
